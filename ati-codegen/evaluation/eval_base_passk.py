...
TIMEOUT = 3
MAX_TOKENS = 2048
NUM_SAMPLES = 10  # pass@10: 每个问题生成10个样本
TEMPERATURE = 0.8  # pass@k 需要较高的温度以增加多样性
...
# =========================
# GENERATION FOR PASS@5 AND PASS@10
# =========================
...
print(f"Generating {len(all_prompts)} code samples ({NUM_SAMPLES} per problem)...")
outputs = llm.generate(all_prompts, sampling_params)

# =========================
# EVALUATION FOR PASS@5 AND PASS@10
# =========================
...
print("\n" + "=" * 60)
print("MBPP PASS@K EVALUATION RESULTS")
print("=" * 60)
